const ERRORS_MESSAGE = {
  ...
  PULL_REQUEST_NOT_CLOSED:
    "The pull request must be merged and closed to evaluate the points",
  PULL_REQUEST_NOT_MERGED:
    "The pull request must be merged to evaluate the points",
  MERGE_REQUEST_EXPIRED:
    "The merge request is expired, Maximum time limit is 7 days",
...
export { ERRORS_MESSAGE, SUCCESS_MESSAGE };
