...
import { BAN_CONTRIBUTOR, DELETE_PROJECT_SELECTED_BY_CONTRIBUTOR, getAllContributors, getContributorSelf } from "../controllers/contributor/contributor.controller";
...
router.post("/ban-contributor/:contributorId",[VERIFY_TOKEN,VERIFY_ROLE_ADMIN],BAN_CONTRIBUTOR)
